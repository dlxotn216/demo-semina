...
public final class MemberDto {
    ...
    public static MemberSearchResponse asMemberSearchResponse(Member member){
        return new MemberSearchResponse(member.getMemberKey(), member.getMemberId(), member.getMemberName(), member.getPhone(), 
                                        member.getTeam() != null ? member.getTeam().getTeamName() : "");
    }
